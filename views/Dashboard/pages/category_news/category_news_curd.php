...
<body>
    <h3>DANH SÁCH THỂ LOẠI TIN TỨC</h3>
    ...
    <script>
        ...
        function update(id) {
            ...
            $.ajax({
                    url: "http://localhost/manga-comic-be/views/Dashboard/pages/category_news/category_news_api.php?method=2&id=" + id,
                    method: "GET",
                    dataType: "json"
        ...
        BtnUpdate.onclick = function() {
            ...
            $.post(
                "http://localhost/manga-comic-be/views/Dashboard/pages/category_news/category_news_api.php?method=3", {
        ...
        BtnAddNew.onclick = function() {
            ...
            $.post(
                "http://localhost/manga-comic-be/views/Dashboard/pages/category_news/category_news_api.php?method=4", {
        ...
        function dele(id) {
			...
			if(result ==true){
                $.post(
                "http://localhost/manga-comic-be/views/Dashboard/pages/category_news/category_news_api.php?method=5", {
                    id: id
                },
                function(data, status) {
