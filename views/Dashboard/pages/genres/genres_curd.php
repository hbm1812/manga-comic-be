...
<body>
    ...
    <button type="button" class="btn btn-secondary" id="BtnAdd">Thêm mới thể loại</button>
            ...
            <form action="#">
                ...
                <div class="modal_content">
                    ...
                    <div class="content_left">
                        ...
                        <div class="component_container">
                            <span>KEYWORD</span>
                            <textarea name="Addkeyword" id="Addkeyword"></textarea>
                        </div>
                        <div class="component_container">
                            <span>BACKGROUND</span>
    ...
    <script>
        ...
        function update(id) {
            ...
            $.ajax({
                    url: "http://localhost/manga-comic-be/views/Dashboard/pages/genres/genres_api.php?method=2&id=" + id,
                    method: "GET",
                    dataType: "json"
        ...
        BtnUpdate.onclick = function() {
            ...
            $.post(
                "http://localhost/manga-comic-be/views/Dashboard/pages/genres/genres_api.php?method=3", {
        ...
        BtnAddNew.onclick = function() {
            ...
            $.post(
                "http://localhost/manga-comic-be/views/Dashboard/pages/genres/genres_api.php?method=4", {
